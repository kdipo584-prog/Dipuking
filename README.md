        ...
        .admin-row-lef gap: 12px; font-size: 14px; font-weight: 600; color: #f8fafc; }
    ...
    <div id="step-dashboard" style="display: none;">
        ...
        <div id="part-sell-section" class="card">
            ...
            <div class="extra-earn-card">
                <h4 style="border:none; lass="btn btn-pink" style="padding:8px; font-size:12px; margin-top:8px; border-radius:8px;" onclick="copyReferLink()">📋 Copy Refer Link</button>
            </div>
